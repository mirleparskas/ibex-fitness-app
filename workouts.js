const PROGRAM = {
  ...
  accessories: {
    ...
    gluteA: ["12/12 B-stance hip thrust", "15 cable or banded kickbacks/side", "20 frog pumps", "45s plank + 20 hollow rocks"],
    gluteB: ["10/10 Bulgarian split squat", "15 seated band abductions", "12 single-leg RDL/side", "16 weighted hip bridge marches"],
    gluteC: ["20 walking lunges", "15 back extensions with squeeze", "12/12 knee-high step-ups", "20 Copenhagen-style adductions/side"],
